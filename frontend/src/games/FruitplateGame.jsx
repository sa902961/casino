...
export default function FruitplateGame() {
  const apiFn = useCallback((bet, extra) => gameAPI.fruitplate(bet, extra), [])
  const { bet, setBet, result, spinning, play, chips, user } = useGame(apiFn)

  return (
    <GameLayout title="四葉轉盤" emoji="🍀">
      <div style={{ padding:'0 16px' }}>
        ...
        <div style={{ textAlign:'center', padding:'30px 0' }}>
          ...
          <div style={{ color:'#fff', fontSize:20, fontWeight:'bold', marginBottom:8 }}>四葉轉盤</div>
          {result && (
