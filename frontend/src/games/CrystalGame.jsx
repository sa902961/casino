...
export default function CrystalGame() {
  const apiFn = useCallback((bet, extra) => gameAPI.crystal(bet, extra), [])
  const { bet, setBet, result, spinning, play, chips, user } = useGame(apiFn)

  return (
    <GameLayout title="命運水晶球" emoji="🔮">
      <div style={{ padding:'0 16px' }}>
        ...
        <div style={{ textAlign:'center', padding:'30px 0' }}>
          ...
          <div style={{ color:'#fff', fontSize:20, fontWeight:'bold', marginBottom:8 }}>命運水晶球</div>
          {result && (
