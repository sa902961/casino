...
export default function FishBossGame() {
  const apiFn = useCallback((bet, extra) => gameAPI.fishing2(bet, extra), [])
    ...
    <GameLayout title="超級深海炮" emoji="🐙">
      <div style={{ padding:'0 16px' }}>
        ...
        <div style={{ textAlign:'center', padding:'30px 0' }}>
          ...
          <div style={{ color:'#fff', fontSize:20, fontWeight:'bold', marginBottom:8 }}>超級深海炮</div>
          {result && (
