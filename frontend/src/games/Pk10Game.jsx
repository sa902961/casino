...
export default function Pk10Game() {
  const apiFn = useCallback((bet, extra) => gameAPI.pk10(bet, extra), [])
  const { bet, setBet, result, spinning, play, chips, user } = useGame(apiFn)

  return (
    <GameLayout title="PK10賽車" emoji="🏁">
      <div style={{ padding:'0 16px' }}>
        ...
        <div style={{ textAlign:'center', padding:'30px 0' }}>
          ...
          <div style={{ color:'#fff', fontSize:20, fontWeight:'bold', marginBottom:8 }}>PK10賽車</div>
          {result && (
